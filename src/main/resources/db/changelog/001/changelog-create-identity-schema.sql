...
--changeset SergeyBug:create-identity-schema
--comment create new identity schema
create schema identity;
--rollback drop schema identity;

--changeset SergeyBug:create-identity-user_accounts-table
...
--changeset SergeyBug:create-identity-user_roles-table
...
--changeset SergeyBug:create-identity-user_accounts_roles-table
...
--changeset SergeyBug:add-user_accounts_roles-table-constraints
...
--changeset SergeyBug:add-data-to-user_roles-table
